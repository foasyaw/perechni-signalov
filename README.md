...
![AI-assisted](https://img.shields.io/badge/сделано%20в%20связке%20с-ИИ-8A2BE2)
...
- Светлая/тёмная тема, drag & drop чертежей, экспорт в PDF, сохраняемые наборы проектов.
...
Разработано в связке **«инженер + ИИ»**:
постановка задачи, предметная область (АСУ ТП, ГОСТ), нормоконтроль и приёмка результата — инженер;
